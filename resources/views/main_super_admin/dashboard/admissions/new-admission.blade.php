                ...
                <div class="card-body">
                    ...
                    <form class="new-added-form" action="#" method="POST">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Surname*</label>
                                <input type="text" name="surname" id="surname" placeholder="Enter  Email"
                                    class="form-control" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Class *</label>
                                <input type="text" name="class" id="class" required placeholder="Enter class"
                                    class="form-control" />
                            </div>
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Section*</label>
                                <input type="text" name="section" id="surname" placeholder="Enter  section"
                                    class="form-control" />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" name="user_name" id="user_name" placeholder="Enter.." required
                                    class="form-control" />
                            </div>
                            <div class="col-xl-6 col-lg-6 col-12 form-group">
