        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            ...
            <!--  <li class="navbar-item dropdown header-message">
                ...
                <ul class="nav sub-group-menu">
                  ...
                  <li class="nav-item">
                    <a href="student_dashbord.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Students</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="parents_dashbord.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Parents</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="teacher_dashbord.html" class="nav-link"
                ...
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_institutes.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>All Institutes</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="institutes_detail.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Institutes Details</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="institutes_form.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Institutes Form</a
                    >
                  </li>
                  <!-- <li class="nav-item">
                    <a href="student_promotion.html" class="nav-link"
              ...
              <!-- <li class="nav-item sidebar-nav-item">
                ...
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_teacher.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>All Teachers</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="teacher_detail.html" class="nav-link"
              ...
              <li class="nav-item sidebar-nav-item">
                ...
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_parent.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>All Parents</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="parent_detail.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Parents Details</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="add_parent.html" class="nav-link"
              ...
              <li class="nav-item sidebar-nav-item">
                ...
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_book.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>All Book</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="add_new_book.html" class="nav-link"
              ...
              <li class="nav-item sidebar-nav-item">
                <a href="#" class="nav-link"
                  ...
                  ><span>Acconunt</span></a
                >
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_fee_collection.html" class="nav-link"
                  ...
                  <li class="nav-item">
                    <a href="add_expenses.html" class="nav-link"
              ...
              <li class="nav-item sidebar-nav-item">
                <a href="#" class="nav-link"
                  ><i
                    class="flaticon-maths-class-materials-cross-of-a-pencil-and-a-ruler"
                  ></i
                  ><span>Class</span></a
                >
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="all_class.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>All Classes</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="add_class.html" class="nav-link"
              ...
              <li class="nav-item">
                <a href="class_routine.html" class="nav-link"
                  ><i class="flaticon-calendar"></i
                  ><span>Class Routine</span></a
                >
              </li>
              <li class="nav-item">
                <a href="attandence.html" class="nav-link"
              ...
              <li class="nav-item sidebar-nav-item">
                ...
                <ul class="nav sub-group-menu">
                  <li class="nav-item">
                    <a href="exam_schedule.html" class="nav-link"
                      ><i class="fas fa-angle-right"></i>Exam Schedule</a
                    >
                  </li>
                  <li class="nav-item">
                    <a href="exam_grades.html" class="nav-link"
              ...
              <li class="nav-item">
                <a href="noties.html" class="nav-link"
                  ><i class="flaticon-script"></i><span>Notice</span></a
                >
              </li>
              <li class="nav-item">
                <a href="school_main_account.html" class="nav-link"
